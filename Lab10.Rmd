...
```
shows the rank of a response in respect to the question being ask
this makes sense, most questions only have one response, there are more nth responses than (n+1)th responses
```{r,echo=FALSE,message=FALSE}
...
```
lines up well with the distrubion of rank graph
...
* Arie - 
* Anderson- 
* Ethan- ind section and findings, merged and tidied/sorted the two datasets, findings/explanation on team section
* Ryan-