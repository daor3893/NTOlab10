...
merged <- left_join(Questions, Answers, by = c("Id" = "ParentId"))
...
merged2 <- merged %>%
  ...
  select(-CreationDate.x, -CreationDate.y, -Score.x, -Score.y, -Body.x, -Body.y, -Id, -X7.x, -X7.y, -Id.y, -OwnerUserId.x, -OwnerUserId.y, -Title)
